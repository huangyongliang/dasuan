...
// Based on common open source implementations for 1900-2100
...
var nStr2 = ['初', '十', '廿', '卅', '　']
var monthCn = ["正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "冬月", "腊月"]
...
function solar2lunar(y, m, d) {
  ...
  var offset = Math.round((objDate.getTime() - baseDate.getTime()) / 86400000)
  ...
  var monthStr = (isLeap ? "闰" : "") + monthCn[month - 1]
  
  var dayStr = ""
  if(day === 10) dayStr = "初十"
  else if(day === 20) dayStr = "二十"
  else if(day === 30) dayStr = "三十"
  else dayStr = nStr2[Math.floor(day / 10)] + nStr1[day % 10]
